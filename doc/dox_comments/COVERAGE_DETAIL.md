...
- wolfSSL_OCSP_BASICRESP_free
- wolfSSL_OCSP_CERTID_free
- wolfSSL_OCSP_REQUEST_free
- wolfSSL_OCSP_REQUEST_new
- wolfSSL_OCSP_REQ_CTX_free
- wolfSSL_OCSP_REQ_CTX_nbio
- wolfSSL_OCSP_RESPONSE_free
- wolfSSL_OCSP_cert_status_str
- wolfSSL_OCSP_crl_reason_str
- wolfSSL_OCSP_id_cmp
- wolfSSL_OCSP_resp_count
- wolfSSL_OCSP_response_status
- wolfSSL_OCSP_response_status_str
...
- wolfSSL_BIO_method_type
- wolfSSL_BIO_new
- wolfSSL_BIO_new_accept
- wolfSSL_BIO_new_connect
- wolfSSL_BIO_new_dgram
- wolfSSL_BIO_new_fd
- wolfSSL_BIO_new_fp
- wolfSSL_BIO_new_mem_buf
- wolfSSL_BIO_new_socket
- wolfSSL_BIO_new_ssl
- wolfSSL_BIO_new_ssl_connect
- wolfSSL_BIO_next
- wolfSSL_BIO_number_read
- wolfSSL_BIO_number_written
- wolfSSL_BIO_pending
- wolfSSL_BIO_pop
- wolfSSL_BIO_printf
- wolfSSL_BIO_push
...
- wolfSSL_BIO_should_retry
- wolfSSL_BIO_should_write
- wolfSSL_BIO_ssl_shutdown
- wolfSSL_BIO_supports_pending
- wolfSSL_BIO_tell
- wolfSSL_BIO_up_ref
- wolfSSL_BIO_vfree
- wolfSSL_BIO_wpending
- wolfSSL_BIO_write
...
## `wolfssl/wolfcrypt/async.h` (no doc file)

- wc_AsyncGetNumberOfCpus
- wc_AsyncSleep
- wc_AsyncSwInit
- wc_AsyncThreadBind
- wc_AsyncThreadExit
...
## `wolfssl/wolfcrypt/cpuid.h` (no doc file)
...
## `wolfssl/wolfcrypt/dilithium.h` (no doc file)

- wc_MlDsaKey_GetPrivLen
- wc_MlDsaKey_GetPubLen
- wc_MlDsaKey_GetSigLen
...
## `wolfssl/wolfcrypt/fips_test.h` (no doc file)

- wc_GetCastStatus_fips
- wc_RunAllCast_fips
- wc_RunCast_fips
- wolfCrypt_GetCoreHash_fips
- wolfCrypt_GetMode_fips
- wolfCrypt_GetRawComputedHash_fips
...
- wc_HmacCopy
- wc_HmacFinal_Software
- wc_HmacFree
- wc_HmacInit
- wc_HmacSizeByType
- wc_HmacUpdate_Software

## `wolfssl/wolfcrypt/hpke.h` (no doc file)
...
- wc_ForceZero
- wolfSSL_SetMemFailCount

## `wolfssl/wolfcrypt/pkcs12.h` (no doc file)
...
## `wolfssl/wolfcrypt/rc2.h` (no doc file)

- wc_Rc2Free
- wc_Rc2SetIV

## `wolfssl/wolfcrypt/rng_bank.h` (no doc file)
...
## `wolfssl/wolfcrypt/selftest.h` (no doc file)

- wolfCrypt_GetVersion_CAVP_selftest
- wolfCrypt_SelfTest
...
## `wolfssl/wolfcrypt/sp_int.h` (no doc file)

- CheckRunTimeFastMath

## `wolfssl/wolfcrypt/wc_lms.h` (no doc file)

- wc_LmsKey_ExportPub
- wc_LmsKey_Free
- wc_LmsKey_GetPrivLen
- wc_LmsKey_GetPubLen
- wc_LmsKey_GetSigLen
- wc_LmsKey_Init
- wc_LmsKey_MakeKey
- wc_LmsKey_ParmToStr
- wc_LmsKey_Reload
- wc_LmsKey_SetContext
- wc_LmsKey_SetLmsParm
- wc_LmsKey_SigsLeft

## `wolfssl/wolfcrypt/wc_mlkem.h` (no doc file)
...
## `wolfssl/wolfcrypt/wc_pkcs11.h` (no doc file)
...
## `wolfssl/wolfcrypt/wc_xmss.h` (no doc file)

- wc_XmssKey_ExportPub
- wc_XmssKey_Free
- wc_XmssKey_GetParamStr
- wc_XmssKey_GetPrivLen
- wc_XmssKey_GetPubLen
- wc_XmssKey_GetSigLen
- wc_XmssKey_Init
- wc_XmssKey_MakeKey
- wc_XmssKey_Reload
...
## `wolfssl/wolfcrypt/wolfentropy.h` (no doc file)

- wc_Entropy_Get
- wc_Entropy_GetRawEntropy
- wc_Entropy_OnDemandTest

## `wolfssl/wolfcrypt/wolfevent.h` (no doc file)

- wolfEventQueue_Add
- wolfEventQueue_Count
- wolfEventQueue_Free
- wolfEventQueue_Init
- wolfEventQueue_Pop
- wolfEventQueue_Push
...
## `wolfssl/wolfcrypt/wolfmath.h` (no doc file)
...
- wolfIO_SetTimeout
- wolfSSL_BIO_ADDR_clear
- wolfSSL_BIO_ADDR_free
- wolfSSL_BIO_ADDR_new
