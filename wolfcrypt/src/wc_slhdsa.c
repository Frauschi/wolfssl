    ...
    SlhDsaKey* key, word32 inSz)
{
     ...
     * in a single parse, mirroring the approach used by PrivateKeyDecode. */
    ...
    /* Map the detected OID key type to an SLH-DSA parameter set. */
...
/* Encode an SLH-DSA private key to DER (PKCS#8 / OneAsymmetricKey).
 * RFC 9909 Section 6: The privateKey field contains the full expanded
